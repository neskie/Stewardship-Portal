...
<body onLoad="ajax_populate_forms();">
  <div id="header">
	  	...
	  	<div id="content" class="column">
			<form id="tng_link_schema" 
				...
				<h1 class="pageName"> Associate Schema With Form </h1>
					<p>
						This page allows the portal administrator to 
						associate one or more schemas with a form.
					</p>
		         <p>
		         	Once a form is selected in the drop-down “Form:” 
		         	list below, you will be able to see the list of 
		         	linked and unlinked schemas with respect to that 
		         	selected form.
		         </p> 
		         <p>
		         	To associate a schema with the selected form, 
		         	select the schema from the <b>Unlinked Schemas</b> 
		         	box and click the DOWN ARROW toggle button to 
		         	move it to the <b>Linked Schemas</b> box.
		         </p> 
		         <p>
		         	To remove an associated schema from the selected 
		         	form, select the schema from the <b>Linked Schemas</b> 
		         	box and click the UP ARROW toggle button to move it to 
		         	the <b>Unlinked Schemas</b> box.
		         </p>
		         <p>
		         	<i>One form can have multiple schemas associated 
		         	with it, and one schema can be reused and be 
		         	associated with multiple forms, if appropriate.</i>
		         </p>
					<br/>
					<p>
