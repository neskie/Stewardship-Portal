...
function add_file_input(){	 
	var form = document.getElementById('tng_display_form');
	file_count++;
...
<div id="container">
	...
	<div id="content">
		<form id="tng_display_form" name="tng_display_form" method="post" enctype="multipart/form-data" action="tng_display_form.php">
			<br/>
       		<?php
			...
			<!-- 
				...
				read only mode.
			-->
			<input type="button" onclick="add_file_input()" value="Add File" class="button" <?php if($_SESSION['readonly'] == 'true') echo "disabled"; ?>/>
			<input type="button" onclick="submit_form()" value="Submit" class="button" <?php if($_SESSION['readonly'] == 'true') echo "disabled"; ?> />
			<hr />
		</form>
	</div>
