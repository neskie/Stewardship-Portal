...
<link rel="stylesheet" href="../adobe_test/mm_health_nutr.css" type="text/css" />
<title>Untitled Document</title>
</head>

<body>
<table border="0" cellspacing="0" cellpadding="0" width="165" id="navigation"  bgcolor="#5C743D">
        <tr>
          <td width="165">&nbsp;<br />
		 &nbsp;<br /></td>
        </tr>
        ...
        <tr>
          <td width="165"><a href="javascript:window.location='tng_select_layers.php';" 
